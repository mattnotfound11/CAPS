...
export function LoginEntryCards() {
  return (
    <section
      ...
      className="border-t border-white/[0.05] bg-transparent animate-section animate-section-delay-1 relative z-10"
    >
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    {/* Icon badge */}
                    <span
                      className="inline-flex h-16 w-16 items-center justify-center rounded-3xl shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] ring-1 ring-white/10"
                    ...
                    <div className="flex items-center gap-2 rounded-full bg-black/40 px-3 py-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] border border-white/5 backdrop-blur-md">
                      <span className="relative flex h-2 w-2">
                        <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#32D74B] opacity-75"></span>
                        <span className="relative inline-flex h-2 w-2 rounded-full bg-[#32D74B] shadow-[0_0_8px_#32D74B]"></span>
                      </span>
                ...
                <div className="flex flex-1 flex-col px-10 pb-10 pt-2 relative z-10">
                  ...
                  <Link
                    href={href}
                    className="mt-8 flex cursor-pointer items-center justify-center gap-2 rounded-2xl px-6 py-4 text-sm font-bold shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]
                      transition-all duration-300 hover:opacity-90 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:scale-[1.02]
